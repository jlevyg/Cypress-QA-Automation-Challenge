...
- Fix the limitations listed in SUMMARY.md: the date picker helper for single-digit days, and checking summary values row by row instead of with 'contain' on the whole table.
